...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    /**
     * @dev This is function  Chainlink node will call to check if lottery is ready to pick a winner.
